...
public class MyGLRenderer implements GLSurfaceView.Renderer {
   ...
   // private Square   mSquare;
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        mPodstawa1 = new Triangle(kontekst, kolor1, wierzcholki1, 1);
        mPodstawa2 = new Triangle(kontekst, kolor1, wierzcholki2, 1);


        mSciana1 = new Triangle(kontekst, kolor2, wierzcholki3, 1);
        mSciana2 = new Triangle(kontekst, kolor3, wierzcholki4, 0);
        mSciana3 = new Triangle(kontekst, kolor4, wierzcholki5, 2);
        mSciana4 = new Triangle(kontekst, kolor4, wierzcholki6, 1);
    ...
    public void onDrawFrame(GL10 unused) {
        ...
        Matrix.setRotateM(mRotationMatrix, 0, mAngle, 1.0f, 1.0f, 0.0f);
